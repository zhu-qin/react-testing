...
var _drawerPanel = __webpack_require__(34);

var _mainPanel = __webpack_require__(33);
  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      var listener = function listener() {
        clearTimeout(_this2.stateTimeout);
        _this2.stateTimeout = setTimeout(function () {
          return _this2.setState({ appState: _this2.props.store.getState() });
        }, 100);
      };
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: this.state.appState.settings.isOpen ? 'side-panel' : 'hidden' },
          _react2.default.createElement(_drawerPanel.DrawerPanel, { appState: this.state.appState, actions: this.props.actions })
        ),
        _react2.default.createElement(
          'div',
          null,
          _react2.default.createElement(_mainPanel.MainPanel, { appState: this.state.appState, actions: this.props.actions })
        )
      );
    }
  }]);
...
function createSetterReducer(actionType) {
  return function setterReducer() {
    ...
    if (actionType === action.type) {
      ...
      return Object.assign({}, state, _defineProperty({}, action.resource, action.payload));
    } else {
      return state;
    }
  };
...
var store = _redux2.default.createStore(_redux2.default.combineReducers(_reducers2.default), preloadedState);
var actions = (0, _actions2.default)(store.dispatch);

window.reduxActions = actions;
window.reduxStore = store;

var startApp = function startApp() {
  _reactDom2.default.render(_react2.default.createElement(_app.App, { store: store, actions: actions }), document.getElementById('root'));
};
...
*/
var aa=__webpack_require__(6),l=__webpack_require__(8),B=__webpack_require__(3),C=__webpack_require__(1),ba=__webpack_require__(7),da=__webpack_require__(11),ea=__webpack_require__(12),fa=__webpack_require__(9),ia=__webpack_require__(10),D=__webpack_require__(2);
...
var MainPanel = exports.MainPanel = function (_React$Component) {
...
var DrawerPanel = exports.DrawerPanel = function (_React$Component) {
  _inherits(DrawerPanel, _React$Component);

  function DrawerPanel(props) {
    _classCallCheck(this, DrawerPanel);

    return _possibleConstructorReturn(this, (DrawerPanel.__proto__ || Object.getPrototypeOf(DrawerPanel)).call(this, props));
  }

  _createClass(DrawerPanel, [{
    key: 'componentWillReceiveProps',
    value: function componentWillReceiveProps(nextProps) {}
  }, {
    key: 'render',
